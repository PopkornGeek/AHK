...
;extend make right primary
;position left and right
;set left at 1024x768
;set right at 1280x800

;duplicate with 1024x768 and 1280x800
...
sleep 1000
ChangeDisplaySettingsEx( 2, (ClrDep:=32) , (Wid:=1024) , (Hei:=768) , (Hz:=60) )
sleep 1000
ChangeDisplaySettingsEx( 1, (ClrDep:=32) , (Wid:=1280) , (Hei:=800) , (Hz:=60) )
